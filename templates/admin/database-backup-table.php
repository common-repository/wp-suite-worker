<table id="wps-database-backup-table" class="wp-list-table widefat fixed striped">
  <thead>
    <tr>
      <th>ID</th>
      <th>Backup Name</th>
  ...
  <tbody>
    <?php
    $backups = get_posts(array('post_type' => 'wps-backups', 'posts_per_page' => '-1', 'meta_key' => 'wps_backup_format', 'meta_value' => 'database'));
    if ($backups) {
      ...
      <tr id="no-results">
        <td colspan="8" style="text-align: center;">
          ...
          <a href="#" class="button button-primary btn-green wps-generate-database-backup">Create first backup</a>
        </td>
      </tr>
      <?php
    }
